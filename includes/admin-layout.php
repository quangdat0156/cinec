...
function admin_header($page_title = "Quản Trị Hệ Thống", $active_menu = "dashboard") {
    ...
    $isInAdminDir = ($scriptDir === 'admin');
    $loginUrl = $isInAdminDir ? 'login.php' : 'admin/login.php';
    ...
    // Đường dẫn tương đối động
    $prefix = $isInAdminDir ? '' : 'admin/';
    $rootPrefix = $isInAdminDir ? '../' : '';
    ...
    <head>
        ...
        <style>
            ...
            .custom-scrollbar::-webkit-scrollbar-thumb { background: rgba(6, 42, 173, 0.2); border-radius: 4px; }
            .custom-scrollbar::-webkit-scrollbar-thumb:hover { background: rgba(6, 42, 173, 0.4); }
        </style>
    </head>
    <body class="bg-[#F8FAFC] text-slate-800 font-sans h-full flex antialiased selection:bg-[#05A6F5] selection:text-white">
        ...
        <aside class="w-72 bg-[#02185D] text-white flex flex-col justify-between hidden lg:flex shrink-0 fixed inset-y-0 left-0 z-50 shadow-xl">
            <div class="flex flex-col h-full overflow-y-auto custom-scrollbar p-5 space-y-6">
                ...
                <div class="pt-2 px-2 flex items-center justify-between">
                    <a href="<?php echo $prefix; ?>dashboard.php" class="flex items-center gap-3 focus:outline-none">
                ...
                <nav class="space-y-1.5 text-xs font-bold">
                    ...
                    <a href="<?php echo $prefix; ?>dashboard.php" class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all <?php echo $active_menu === 'dashboard' ? 'bg-[#05A6F5] text-white shadow-md' : 'text-slate-300 hover:bg-white/10 hover:text-white'; ?>">
                    ...
                    <a href="<?php echo $prefix; ?>about.php" class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all <?php echo $active_menu === 'about' ? 'bg-[#05A6F5] text-white shadow-md' : 'text-slate-300 hover:bg-white/10 hover:text-white'; ?>">
                        <i data-lucide="building-2" class="w-4 h-4"></i>
                        <span>Quản Lý Giới Thiệu</span>
                    </a>

                    <a href="<?php echo $prefix; ?>programs.php" class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all <?php echo $active_menu === 'programs' ? 'bg-[#05A6F5] text-white shadow-md' : 'text-slate-300 hover:bg-white/10 hover:text-white'; ?>">
                        <i data-lucide="layers" class="w-4 h-4"></i>
                        <span>Quản Lý Chương Trình</span>
                    </a>

                    <a href="<?php echo $prefix; ?>events.php" class="flex items-center justify-between px-3.5 py-2.5 rounded-2xl transition-all <?php echo $active_menu === 'events' ? 'bg-[#05A6F5] text-white shadow-md' : 'text-slate-300 hover:bg-white/10 hover:text-white'; ?>">
                    ...
                    <a href="<?php echo $prefix; ?>news.php" class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all <?php echo $active_menu === 'news' ? 'bg-[#05A6F5] text-white shadow-md' : 'text-slate-300 hover:bg-white/10 hover:text-white'; ?>">
                        <i data-lucide="newspaper" class="w-4 h-4"></i>
                        <span>Quản Lý Tin Tức & Insight</span>
                    </a>

                    <a href="<?php echo $prefix; ?>impact.php" class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all <?php echo $active_menu === 'impact' ? 'bg-[#05A6F5] text-white shadow-md' : 'text-slate-300 hover:bg-white/10 hover:text-white'; ?>">
                        <i data-lucide="trending-up" class="w-4 h-4"></i>
                        <span>Quản Lý Impact</span>
                    </a>

                    <a href="<?php echo $prefix; ?>partners.php" class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all <?php echo $active_menu === 'partners' ? 'bg-[#05A6F5] text-white shadow-md' : 'text-slate-300 hover:bg-white/10 hover:text-white'; ?>">
                    ...
                    <a href="<?php echo $prefix; ?>contacts.php" class="flex items-center justify-between px-3.5 py-2.5 rounded-2xl transition-all <?php echo $active_menu === 'contacts' ? 'bg-[#05A6F5] text-white shadow-md' : 'text-slate-300 hover:bg-white/10 hover:text-white'; ?>">
                        <div class="flex items-center gap-3">
                    ...
                    <a href="<?php echo $prefix; ?>settings.php" class="flex items-center gap-3 px-3.5 py-2.5 rounded-2xl transition-all <?php echo $active_menu === 'settings' ? 'bg-[#05A6F5] text-white shadow-md' : 'text-slate-300 hover:bg-white/10 hover:text-white'; ?>">
            ...
            <div class="p-4 border-t border-white/10 bg-black/20 flex items-center justify-between">
                ...
                <a href="<?php echo $prefix; ?>logout.php" title="Đăng xuất" class="p-2 text-slate-400 hover:text-rose-400 rounded-lg hover:bg-white/10 transition-colors">
        ...
        <div class="flex-1 flex flex-col min-w-0 lg:pl-72">
            ...
            <header class="bg-white border-b border-slate-200 sticky top-0 z-40 h-16 flex items-center justify-between px-4 sm:px-8 shadow-xs">
                ...
                <!-- Right Quick Links -->
                <div class="flex items-center gap-3">
                    <a href="<?php echo $rootPrefix; ?>index.php" target="_blank" class="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold transition-all shadow-2xs">
                        <i data-lucide="external-link" class="w-3.5 h-3.5 text-[#062AAD]"></i>
                        <span class="hidden sm:inline">Xem Trang Chủ</span>
                    </a>
                    
                    <a href="<?php echo $prefix; ?>logout.php" class="p-2 rounded-xl text-slate-400 hover:text-rose-600 hover:bg-rose-50 transition-colors" title="Đăng xuất">
