<?php
/**
 * Mentor Booking Modal Component - CiNEC
...
<div id="mentorBookingModal" class="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 hidden">
    <div class="bg-white rounded-3xl shadow-2xl border border-slate-200 w-full max-w-xl max-h-[92vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div class="p-6 bg-gradient-to-r from-[#02185D] via-[#062AAD] to-[#05A6F5] text-white flex items-center justify-between shrink-0">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-base font-extrabold text-white">Đặt Lịch Hẹn Chuyên Gia Mentor</h3>
                    <p class="text-[11px] text-blue-100 font-light">Tư vấn 1:1 đồng hành cùng dự án đổi mới sáng tạo & khởi nghiệp</p>
                </div>
            </div>
        ...
        <form action="dat-lich-mentor.php" method="POST" class="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-4 text-xs text-left">
            ...
            <!-- 1. KHỐI HIỂN THỊ CHUYÊN GIA ĐÃ CHỌN (KHÔNG CẦN CHỌN LẠI DANH SÁCH) -->
            <div class="bg-blue-50/70 p-3.5 rounded-2xl border border-blue-100 flex items-center gap-3.5">
                ...
                <div class="min-w-0 flex-1">
                    <span class="text-[10px] font-black uppercase text-[#05A6F5] tracking-wider block">Chuyên Gia Cố Vấn</span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div class="space-y-1">
                    ...
                    <input type="text" name="fullname" required placeholder="Nguyễn Văn A" class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl font-medium focus:bg-white focus:border-[#05A6F5] outline-none">
                </div>
                <div class="space-y-1">
                    <label class="block font-bold text-slate-700">Số Điện Thoại <span class="text-rose-500">*</span></label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div class="space-y-1">
                    <label class="block font-bold text-slate-700">Tên Dự Án / Doanh Nghiệp</label>
                    <input type="text" name="organization" placeholder="Startup / HTX / Doanh nghiệp..." class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl font-medium focus:bg-white focus:border-[#05A6F5] outline-none">
                </div>
            </div>

            <!-- 3. BA LỰA CHỌN HÌNH THỨC GẶP (ĐÃ ẨN THÔNG TIN NỘI BỘ HỆ THỐNG) -->
            <div class="space-y-2 pt-1">
                <label class="block font-extrabold text-slate-800 text-xs">
                    Hình Thức Gặp Mentor <span class="text-rose-500">*</span>:
                </label>
                ...
                <div class="grid grid-cols-1 gap-2.5">
                    ...
                    <label class="flex items-start gap-3 p-3 rounded-2xl border border-slate-200 hover:border-[#05A6F5] hover:bg-blue-50/40 transition-all cursor-pointer bg-slate-50/60 has-[:checked]:border-[#05A6F5] has-[:checked]:bg-blue-50/70 has-[:checked]:ring-2 has-[:checked]:ring-[#05A6F5]/20">
                        ...
                        <div class="space-y-0.5">
                            <div class="font-extrabold text-[#02185D] flex items-center gap-1.5">
                                ...
                                <span>Gặp tại văn phòng CiNEC</span>
                            </div>
                            <p class="text-[11px] text-slate-500 font-normal">Toà nhà CiNEC, số 16 - 18 Cù Chính Lan, P. Bạc Liêu, TP. Cà Mau (Phòng họp chuyên gia)</p>
                        </div>
                    </label>
                    ...
                    <label class="flex items-start gap-3 p-3 rounded-2xl border border-slate-200 hover:border-amber-400 hover:bg-amber-50/40 transition-all cursor-pointer bg-slate-50/60 has-[:checked]:border-amber-500 has-[:checked]:bg-amber-50/70 has-[:checked]:ring-2 has-[:checked]:ring-amber-500/20">
                        ...
                        <div class="space-y-0.5 flex-1">
                            ...
                            <p class="text-[11px] text-slate-500 font-normal">Đề xuất địa điểm gặp mặt phù hợp với bạn (Quán Cafe, Trụ sở doanh nghiệp / HTX...)</p>
                            
                            <!-- Input địa chỉ đề xuất (hiện khi chọn) -->
                            <div id="customLocationBox" class="hidden pt-2">
                                <input type="text" name="custom_location_detail" placeholder="Nhập địa chỉ cụ thể đề xuất..." class="w-full px-3 py-2 bg-white border border-amber-300 rounded-xl text-[11px] font-medium text-slate-800 focus:outline-none">
                            </div>
                        </div>
                    </label>
                    ...
                    <label class="flex items-start gap-3 p-3 rounded-2xl border border-slate-200 hover:border-purple-400 hover:bg-purple-50/40 transition-all cursor-pointer bg-slate-50/60 has-[:checked]:border-purple-500 has-[:checked]:bg-purple-50/70 has-[:checked]:ring-2 has-[:checked]:ring-purple-500/20">
                        ...
                        <div class="space-y-0.5">
                            <div class="font-extrabold text-slate-800 flex items-center gap-1.5">
                                ...
                                <span>Họp trực tuyến (Online)</span>
                            </div>
                            <p class="text-[11px] text-slate-500 font-normal">Trao đổi 1:1 qua Google Meet / Zoom (Link phòng họp sẽ được gửi qua Email & Zalo của bạn)</p>
                        </div>
                    </label>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                <div class="space-y-1">
                    <label class="block font-bold text-slate-700">Ngày Hẹn Mong Muốn</label>
                ...
                <div class="space-y-1">
                    <label class="block font-bold text-slate-700">Khung Giờ</label>
                    <select name="preferred_time" class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl font-medium focus:bg-white focus:border-[#05A6F5] outline-none">
                        ...
                        <option value="15:30 - 17:00 (Chiều)">15:30 - 17:00 (Chiều)</option>
                    </select>
                </div>
            </div>

            <div class="space-y-1">
                <label class="block font-bold text-slate-700">Nội Dung / Vấn Đề Cần Mentor Tư Vấn</label>
                <textarea name="message" rows="2" placeholder="Mô tả tóm tắt khó khăn, mục tiêu cần giải đáp (Vốn, công nghệ AI, nâng chuẩn OCOP, pháp lý...)" class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl font-medium focus:bg-white focus:border-[#05A6F5] outline-none leading-relaxed"></textarea>
            </div>

            <!-- Nút gửi -->
            <div class="pt-3 border-t border-slate-100 flex items-center justify-end gap-3">
                <button type="button" onclick="closeMentorModal()" class="px-5 py-2.5 rounded-xl border border-slate-200 font-bold text-slate-600 hover:bg-slate-50">Đóng</button>
