<?php
$page_title = "Nền tảng Đổi mới sáng tạo Cà Mau (Ca Mau Innovation Platform)";
...
<div class="bg-[#FAFCFF] min-h-screen pt-28 pb-16">
    <div class="max-w-[1440px] mx-auto px-4 md:px-12 2xl:px-20 space-y-12">
        ...
        <nav class="flex items-center gap-2 text-body-xs font-semibold text-slate-500">
            ...
            <i data-lucide="chevron-right" class="w-3.5 h-3.5 text-slate-400"></i>
            <span class="text-blue-600 font-bold"><?php echo $program['title']; ?></span>
        </nav>

        <!-- HERO SECTION BANNER -->
        <div class="bg-gradient-to-br from-blue-900 via-indigo-900 to-[#02185D] rounded-[32px] p-8 md:p-14 text-white shadow-2xl relative overflow-hidden">
            <div class="absolute -right-20 -top-20 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl pointer-events-none"></div>
            <div class="absolute right-40 -bottom-20 w-80 h-80 bg-indigo-500/20 rounded-full blur-3xl pointer-events-none"></div>

            <div class="relative z-10 max-w-4xl space-y-6">
                <div class="flex flex-wrap items-center gap-3">
                    <span class="inline-flex items-center gap-2 bg-blue-500/20 border border-blue-400/30 text-blue-200 px-4 py-1.5 rounded-full text-body-xs font-extrabold uppercase tracking-wider backdrop-blur-md">
                ...
                <p class="text-body-xs font-bold text-blue-300 tracking-wider uppercase">
                ...
                <div class="grid grid-cols-3 gap-4 pt-6 border-t border-blue-700/50 max-w-2xl">
                    <?php foreach ($program['key_metrics'] as $metric): ?>
                        <div>
                            <div class="text-h4 md:text-h3 font-black text-blue-300"><?php echo $metric['number']; ?></div>
                ...
                <div class="pt-4 flex flex-wrap items-center gap-4">
                    <a href="#register-section" class="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-extrabold text-body-sm px-6 py-3.5 rounded-full transition-all shadow-lg hover:shadow-blue-500/30">
                        <span>Đăng ký tham gia Mạng lưới Đổi mới sáng tạo</span>
                    ...
                    <a href="lien-he.php" class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-bold text-body-sm px-6 py-3.5 rounded-full transition-all border border-white/20">
                        <span>Đề xuất Quy chế Sandbox</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-3xl p-6 md:p-8 border border-slate-200/80 shadow-sm space-y-4 flex items-start gap-5">
                <div class="w-14 h-14 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center shrink-0 border border-indigo-200 shadow-2xs mt-1">
                    <i data-lucide="users" class="w-7 h-7"></i>
                </div>
                <div class="space-y-2">
                    <span class="text-[10px] font-black uppercase tracking-wider text-indigo-600">ĐỐI TƯỢNG HƯỚNG TỚI</span>
        ...
        <div class="space-y-6">
            <div class="text-center space-y-2 max-w-2xl mx-auto">
                <span class="text-body-xs font-black uppercase tracking-wider text-blue-600">NỘI DUNG CHỦ YẾU</span>
                <h2 class="text-h3 font-extrabold text-[#02185D]">Nội Dung Trọng Tâm Chương Trình</h2>
                <p class="text-body-xs text-slate-500">Xây dựng thể chế, nền tảng dữ liệu số và đánh giá Chỉ số PII cấp tỉnh</p>
            </div>
        ...
        <div class="bg-blue-950 text-white rounded-3xl p-8 md:p-12 space-y-8 shadow-xl">
            <div class="text-center space-y-2 max-w-2xl mx-auto">
                <span class="text-body-xs font-black uppercase tracking-wider text-blue-300">KẾT QUẢ ĐẦU RA</span>
                <h2 class="text-h3 font-extrabold text-white">Sản Phẩm Đầu Ra Đạt Được</h2>
                <p class="text-body-xs text-blue-200/80 font-light">Cơ sở hạ tầng pháp lý, hệ thống dữ liệu điều hành và xếp hạng Chỉ số PII tỉnh Cà Mau</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <?php foreach ($program['outputs'] as $out): ?>
                    <div class="bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl p-6 space-y-3 hover:bg-white/15 transition-all">
                        <div class="w-10 h-10 rounded-xl bg-blue-500/30 text-blue-300 flex items-center justify-center">
        ...
        <div id="register-section" class="bg-white rounded-3xl p-8 md:p-12 border border-slate-200/80 shadow-md max-w-4xl mx-auto space-y-8">
            <div class="text-center space-y-2">
                ...
                <h2 class="text-h3 font-extrabold text-[#02185D]">Đăng Ký Tham Gia Nền Tảng Đổi Mới Sáng Tạo</h2>
                <p class="text-body-xs text-slate-500">Dành cho tổ chức, doanh nghiệp hoặc chuyên gia muốn đóng góp vào hạ tầng Đổi mới sáng tạo Cà Mau.</p>
            </div>

            <form action="lien-he.php" method="GET" class="space-y-6">
                <input type="hidden" name="program" value="PLATFORM">
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-body-xs font-bold text-slate-700">Họ và tên người đăng ký *</label>
                    ...
                    <div class="space-y-2">
                        <label class="text-body-xs font-bold text-slate-700">Tên Tổ chức / Doanh nghiệp / Đơn vị</label>
                        <input type="text" placeholder="Sở/Ngành/Viện trường/Doanh nghiệp..." class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-blue-500 text-body-xs">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <label class="text-body-xs font-bold text-slate-700">Nội dung quan tâm</label>
                        <select class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-blue-500 text-body-xs text-slate-700">
                            <option>Đề xuất mô hình thử nghiệm Quy chế Sandbox</option>
                            <option>Đóng góp Dữ liệu Đổi mới sáng tạo Cà Mau</option>
                            <option>Tham gia Mạng lưới Hội đồng Chuyên gia Cố vấn</option>
                            <option>Tư vấn cải thiện Chỉ số PII</option>
                        </select>
                    </div>
                </div>

                <div class="space-y-2">
                    <label class="text-body-xs font-bold text-slate-700">Nội dung đề xuất cụ thể</label>
                    <textarea rows="4" placeholder="Mô tả đề xuất chính sách, quy chế sandbox hoặc đóng góp dữ liệu..." class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-blue-500 text-body-xs"></textarea>
                </div>
        ...
        <div class="pt-8 border-t border-slate-200">
            <h3 class="text-body-xs font-extrabold text-slate-400 uppercase tracking-wider mb-4 text-center">Các chương trình thành phần khác trong hệ thống tích hợp</h3>
